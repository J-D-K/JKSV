...
inline std::shared_ptr<saveCreateState> createSaveCreationState(data::user *currentUser, FsSaveDataType saveDataType)
{
    return std::make_shared<saveCreateState>(currentUser, saveDataType);
}
