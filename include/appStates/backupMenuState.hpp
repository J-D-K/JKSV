...
inline std::shared_ptr<backupMenuState> createBackupMenuState(data::user *currentUser, data::userSaveInfo *currentUserSaveInfo, data::titleInfo *currentTitleInfo)
{
    return std::make_shared<backupMenuState>(currentUser, currentUserSaveInfo, currentTitleInfo);
}
