...
inline std::shared_ptr<progressState> createNewProgressTask(sys::taskFunction threadFunction, sys::sharedTaskData sharedData)
{
    return std::make_shared<progressState>(threadFunction, sharedData);
}
